export default function handler(req, res) {
	res.status(200).json([
		...
		},
		{
			...
			author: null,
			title:
				"Lindsay Lohan Remembers Aaron Carter (Exclusive) - Entertainment Tonight",
			description:
				"Lindsay Lohan opens up to ET about Aaron Carter, who died Saturday at 34. The actress and the singer dated when they were teenagers. Lohan also shares an upd...",
			url: "https://www.youtube.com/watch?v=tldKbUn35nE",
			urlToImage: "https://i.ytimg.com/vi/tldKbUn35nE/maxresdefault.jpg",
			publishedAt: "2022-11-08T21:52:09Z",
			content: null,
		},
		{
			source: {
			...
			author: "Alex Hern",
			title:
				"Binance to buy FTX in major cryptocurrency exchange merger - The Guardian",
			description:
				"Public squabble between the two largest offshore exchanges’ bosses led to run on FTX and forced sale",
			url: "https://www.theguardian.com/technology/2022/nov/08/binance-to-buy-ftx-in-major-cryptocurrency-exchange-merger",
			urlToImage:
				"https://i.guim.co.uk/img/media/6b8baec5763b0c05ace9e3cee5b82b4dace9337f/0_57_3500_2100/master/3500.jpg?width=1200&height=630&quality=85&auto=format&fit=crop&overlay-align=bottom%2Cleft&overlay-width=100p&overlay-base64=L2ltZy9zdGF0aWMvb3ZlcmxheXMvdGctZGVmYXVsdC5wbmc&enable=upscale&s=7b355eed9ece7b4603a1cda7cc4bfd34",
			publishedAt: "2022-11-08T21:49:00Z",
			content:
				"The two largest offshore cryptocurrency exchanges are merging, after a week of public squabbling between Binances chief executive, Changpeng Zhao, and FTXs boss, Sam Bankman-Fried, triggered a bank r… [+4153 chars]",
		},
		{
			source: {
				id: null,
			...
			author: null,
			title:
				"Watch LIVE: Maricopa County officials give update as voting machine problems reported. - AZFamily 3TV and CBS 5 News",
			description:
				"Maricopa County officials give update as voting machine problems reported.",
			url: "https://www.youtube.com/watch?v=s495N8Nldmw",
			urlToImage:
				"https://i.ytimg.com/vi/s495N8Nldmw/maxresdefault.jpg?sqp=-oaymwEmCIAKENAF8quKqQMa8AEB-AH-CYAC0AWKAgwIABABGGUgXChLMA8=&rs=AOn4CLBpyI5i47uF30cjrAaNJ_IplGn4OA",
			publishedAt: "2022-11-08T21:34:54Z",
			content: null,
		},
		{
			source: {
			...
			author: "Paolo Ragusa",
			title:
				"Hozier on His New Song for God of War: Ragnarök, “Blood Upon the Snow”: Exclusive - Consequence",
			description:
				"Folk artist premieres his contribution to the game's OST, plus talks about working on his third album.",
			url: "https://consequence.net/2022/11/hozier-blood-upon-the-snow-god-of-war-interview/",
			urlToImage:
				"https://consequence.net/wp-content/uploads/2022/11/hozier-social.jpg?quality=80",
			publishedAt: "2022-11-08T21:32:00Z",
			content:
				"The hype has been building for God of War: Ragnarök (out November 9th on PlayStation 5 and PlayStation 4), the newest installment of the hit video game series. Not only is it the first new God of War… [+2867 chars]",
		},
		{
			source: {
				id: null,
			...
			title:
				"Evacuations Ordered For Thousands In Florida Ahead Of Tropical Storm Nicole - The Weather Channel",
			description:
				"With 34 Florida counties under a state of emergency ahead of Tropical Storm Nicole, residents in some vulnerable areas are being advised to evacuate. - Articles from The Weather Channel | weather.com",
			url: "https://weather.com/safety/hurricane/news/2022-11-07-florida-hurricane-nicole-emergency-preparations",
			urlToImage: "https://s.w-x.co/NicolePrepsBrevardFL9.8.22.png",
			publishedAt: "2022-11-08T21:28:07Z",
			content:
				"At a Glance\r\n<ul><li>Mandatory evacuations have been ordered in Palm Beach County.</li><li>Other areas are opening shelters.</li><li>Thirty-four counties are under a state of emergency.</li></ul>\r\nSi… [+6386 chars]",
		},
		{
			source: {
				id: null,
			...
			title:
				"Disney Stock Falls On Earnings Miss But Disney+ Beats Estimates - Investor's Business Daily",
			description:
				"Disney+ subscriber growth beat forecasts, but the company's earnings and revenue missed forecasts",
			url: "https://www.investors.com/news/disney-earnings-disney-plus-subscribers/",
			urlToImage:
				"https://www.investors.com/wp-content/uploads/2020/06/Stock-Disneyland-61-shutt.jpg",
			publishedAt: "2022-11-08T21:23:00Z",
			content:
				"Walt Disney (DIS) reported a decline in Q4 earnings Tuesday afternoon, ending the company's growth streak. The Dow Jones entertainment giant's earnings have steadily improved over the last six quarte… [+3574 chars]",
		},
		{
			source: {
				id: null,
			...
			url: "https://www.theguardian.com/world/2022/nov/08/exceptional-trove-of-24-ancient-statues-found-immersed-in-tuscan-spa",
			urlToImage:
				"https://i.guim.co.uk/img/media/63a2312a0e93d264e18bd2f8c93674036b8e9aad/96_0_2880_1728/master/2880.jpg?width=1200&height=630&quality=85&auto=format&fit=crop&overlay-align=bottom%2Cleft&overlay-width=100p&overlay-base64=L2ltZy9zdGF0aWMvb3ZlcmxheXMvdGctZGVmYXVsdC5wbmc&enable=upscale&s=f9f420b7994197b5e0bee1778f82937c",
			publishedAt: "2022-11-08T20:16:00Z",
			content:
				"An exceptional trove of bronze statues preserved for thousands of years by mud and boiling water have been discovered in a network of baths built by the Etruscans in Tuscany.\r\nThe 24 partly submerged… [+4678 chars]",
		},
		{
			source: {
				id: null,
			...
			title:
				"1 student injured in shooting at Ingraham High School in north Seattle, person in custody - KOMO News",
			description:
				"One person was injured in a shooting at Ingraham High School in north Seattle Tuesday morning.",
			url: "https://komonews.com/news/local/police-respond-to-report-of-school-shooting-in-north-seattle-ingraham-high-school-area",
			urlToImage:
