...
export default function About() {
	return (
		<div className="w-full md:h-screen px-2 flex items-center py-3 flex-col">
				...
				<div className="w-full h-auto flex items-center flex-col py-2 ">
					...
					<div className="w-[700px] bg-white p-2">
						<p className="text-justify w-[375px]:text-sm">
						 <a className="text-blue-500 font-bold text-2xl" href="https://www.ece.fr/">L'ECE</a> Une école internationale au cœur de Paris. A deux
							pas de la Tour Eiffel, le Campus Eiffel est un campus central,
							moderne, qui facilite les interventions de professionnels français
							et internationaux, les conférences, les rencontres d’entreprises.
